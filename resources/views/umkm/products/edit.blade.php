...
@include('partials.navbar', ['title' => 'Edit Produk UMKM'])
...
<div class="container">
    <div class="card">
        ...
        <form method="POST" action="/umkm/produk/{{ $product->id }}/update">
            @csrf
            ...
            <input type="number" name="stok_manual" value="{{ $product->stok_manual }}" required>
